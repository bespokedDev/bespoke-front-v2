...
export default function EnrollmentDetailPage() {
  ...
  const stats = statistics
    ? {
        ...
        lost: statistics.lostClasses?.total || 0,
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center">
        ...
        <PageHeader
          title={enrollment.alias || enrollment.planId.name}
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              <div>
                ...
                <p className="font-medium">
                  {enrollment.classCalculationType === 1
                    ? "Normal (Monthly)"
                    : "Weekly Plan"}
                </p>
              </div>
              ...
              {enrollment.disolve_reason && (
                <div>
                  <Label className="text-muted-foreground">
                    Disolve Reason
                  </Label>
                  <p className="font-medium">{enrollment.disolve_reason}</p>
                </div>
              )}
              <div>
                <Label className="text-muted-foreground">
                ...
                <p className="font-medium">
                  {enrollment.cancellationPaymentsEnabled
                    ? "Enabled"
                    : "Disabled"}
                </p>
              </div>
